...
The solution implemented here is the most efficient possible in Golang using back propagation, channel and go routines and in Scala using back propagation and parallel List.
